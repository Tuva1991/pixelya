        ...
        else
        {
            $image_id = uniqid().'.png';//ファイル名をユニーク化
                if($password == "49B507D1CCFE8BE6")//パスワード認証
                {
                    ...
                    $string = '<li  style="display: inline-block;">'.'<p class="image-txt" style="top: 400px;">'."日本時間".$today.$br."投稿者：".$name.$br."説明".$description."</p>".'<div class="imagebase">'.'<image class="image" src="'.$image_id.'"></image>'."</div>"."</li>".$string;
