            ...
            <div style=" top: 400px; position: relative; z-index: 1000; color: white; font-size: 20px; left: 20px;">
                ...
                <div class="form" style="top: 0px; left: 0px; z-index: 100;"> <!--見ての通りformで送っています。 style="" でごちゃごちゃしているのは index.php でも使った styleを流用しているため、それの調整です。-->
                    ...
                    <form>
                        ...
                        <input type="text" class="form-text" maxlength="50" name="description"  style="top: 0px; left: 0px;"> <!--ここ本当は textareaにしたかったけれども後々いろいろ問題が出てきたので<p>になっています。-->
                ...
                <ul class="image-ul" style="position: relative; top: -300px; z-index: 0;">
                    <?php echo $string;?>
                </ul>
            </div>
    </div>
