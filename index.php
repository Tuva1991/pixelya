...
<body>
    <di>
        <div id="title" class="title">
            <a href="https://lit-fortress-24137.herokuapp.com/index.html"><image class="logo" src="https://lit-fortress-24137.herokuapp.com/image/ぴくせるやロゴ.png"></a>
            </div>
        ...
        <div class="sidebar">  <!--左にあるサイドバー-->
            ...
            <a href="https://lit-fortress-24137.herokuapp.com/index.html" class="sponsorimage">のーいめーじ</a>
            <div class="search">
                <text>検索</text>
                <p>
                    <input type="text" id="search" style="font-family: 'pixel-b'; height: 32px;">
                    <input type="button" value="検索" onclick="search();" style="font-family: 'pixel-b'; height: 40px;">
                </p>
    ...
    <script src="javascriptfolder/click.js"></script>
    <script src="javascriptfolder/start.js"></script>
</body>
</html>